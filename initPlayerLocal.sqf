...
_action = ["digIED","Dig For IED","",{[_player, _target] remoteExec ["PatrolOps_fnc_dig",0,true];},{"ACE_EntrenchingTool" in (items _player)},{},[],[],0.5] call ace_interact_menu_fnc_createAction;   
