/*
 * Author: nkenny modified with KilzoneKids method for finding indoor positions
 ...
 *
 * Example:
 * [bob, 100, true, true] call PatrolOps_fnc_findBuildingPos;
 *
 * Public: Yes
*/
params [
...
// houses
private _houses = nearestObjects [_unit, ["House", "Strategic"], _range, true];

{
    if ((typeOf _x) in patrolOpsBadBuildings) then {
        _houses deleteAt _forEachIndex;
    }
} foreach _houses;
